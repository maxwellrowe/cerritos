...
-->
	...
	<xsl:template match="a">	
		...
		<!-- end show in preview and published -->
		</xsl:if>
		...
		<xsl:if test="$ou:action ='edt'">
			...
			<!-- linked image alt text length > 80 chars -->
