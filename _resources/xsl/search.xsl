...
<div id="searchDiv">
	...
	<div class="gcse-search" enableAutoComplete="true" queryParameterName="q"></div>
-->
	<!--
	<script type="text/javascript">
  function() {
...
<!--<gcse:searchbox-only></gcse:searchbox-only>-->
	<!--<div class="gcse-searchresults-only" enableAutoComplete="true" queryParameterName="q"></div>-->
	<div class="gcse-search" enableAutoComplete="true" queryParameterName="q"></div>
