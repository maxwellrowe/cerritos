                    ...
                    <div class="clearfix">
                        ...
                        <div id="maincontent" class="col-sm-8 col-md-9">
                            ...
                            <div id="contentcontainer">
                                <!-- heading -->
                                <h2>Safety Alert:<xsl:value-of select="$Title" disable-output-escaping="yes" /></h2>
								...
								<p><strong>Reported Offense:</strong>&nbsp;<xsl:apply-templates select="document/ouc:div[@label='offense']" /></p>
