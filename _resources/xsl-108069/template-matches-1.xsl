        ...
        <div class="panel-group" id="accordion{$id}" role="tablist" aria-multiselectable="true">
            ...
            <xsl:for-each select="tbody/tr[@class = 'ou-panel']">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="heading{$id}_{position()}">
                        <h3 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion{$id}" href="#collapse{$id}_{position()}" aria-expanded="false" aria-controls="collapse{$id}_{position()}" aria-label="{$accTitle} Accordion Heading">
                                <xsl:apply-templates select="td[contains(@class, 'ou-title')]/node()" />
                            </a>
                        </h3>
                    </div>
                    <div id="collapse{$id}_{position()}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading{$id}_{position()}">
