...
function displayCalendarListing($y){
	...
	$res .= '            <span class="event-month" style="display: block;text-align: center;text-transform: uppercase;font-size: 18px;">' .  date("M", strtotime($y->pubDate)) . '</span>';
...
echo '<h3></h3><div><a class="button pull-right" href="/campus-guide/academic-calendar.htm">Important Dates</a> <a class="button pull-right" href="https://www.cerritos.edu/calendar/">More Campus Events</a></div>';
