...
$t = new WNL($feed, "/rss/channel/item[cal:tags/cal:tag='College Starts Now']", "OmniCalendarRssItem", "xml");
...
function displayCalendarListing($y){
	...
	$maxChars = 150; /*Previous 200*/
	
	$res = "";
	
	$description = strip_tags($y->description,"<p>&nbsp;");
...
echo '<div class="col-md-4 moreEventsDiv">';
echo '<p><a class="button" href="/calendar/default.htm">MORE EVENTS</a></p>';
echo '</div>';
echo '</div>';
?>