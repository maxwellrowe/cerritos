...
foreach ($degrees_data as $data) {
    ...
    // Store every available program for client-side search expansion
    ...
    if (is_array($rcms)) {
        foreach ($rcms as $rcm) {
            ...
            // Collect detail for full catalog
...
// Consolidate programs matched to selected careers
...
<head>
    ...
    <style>
        :root {
            /* WCAG AAA/AA High Contrast Color Palette */
        ...
        /* High Contrast AAA/AA Compliant Badges with Icons */
        .badge {
            display: inline-flex;
            align-items: center;
            gap: 0.35rem;
...
<main class="container" id="main-content">
    ...
    <p class="intro-text">
        Below are majors recommended for your selected career paths. Review program descriptions below or search by keyword to explore all campus programs.
    </p>
    ...
    <form method="POST" action="majors.php" id="majorForm">
                    ...
                    <article class="program-card <?php echo $is_checked ? 'selected-card' : ''; ?>" 
                        ...
                        <div class="radio-container">
                            <input type="radio" 
                                   ...
                                   onclick="event.stopPropagation(); updateCardSelection();">
                        </div>
                            ...
                            <div class="program-meta">
                                ...
                                <?php if (!empty($prog['credential_type'])): ?>
                                    <span class="badge badge-type">
                                        ...
                                        Credential: <?php echo htmlspecialchars($prog['credential_type']); ?>
                                    </span>
                                <?php endif; ?>
                                <?php if (!empty($prog['credential_category'])): ?>
                                    <span class="badge badge-cat">
                                        ...
                                        Category: <?php echo htmlspecialchars($prog['credential_category']); ?>
                                    </span>
                                <?php endif; ?>
                                ...
                                <?php foreach ($prog['details'] as $det): ?>
                                    ...
                                    <?php if (!empty($det['degree_type'])): ?>
                                        <span class="badge badge-deg-type">
                                            ...
                                            Degree Type: <?php echo htmlspecialchars($det['degree_type']); ?>
                                        </span>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!empty($det['degree_required'])): ?>
                                        <span class="badge badge-req">
                                            ...
                                            Degree Required: <?php echo htmlspecialchars($det['degree_required']); ?>
                                        </span>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </div>
        ...
        <nav class="button-group" aria-label="Form Navigation">
            ...
            <button type="submit" class="btn" id="submitBtn">Proceed to Summary <span aria-hidden="true">&rarr;</span></button>
        </nav>
    </form>
</main>
